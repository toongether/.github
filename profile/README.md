...
작가에게는 연재의 기회를, 독자에게는 다양한 재미를 제공하는 `툰게더`는 팀 프로그래스의 툰게더 Silo에서 개발하는 `웹툰 자유 연재 서비스`입니다.
...
## 📱 :: 지원 플랫폼
2차 릴리즈 기준 웹 서비스는 `작가용 기능`, 앱 서비스는 `독자용 기능`을 제공합니다.

- [Web 사용해보기](https://toongether.kr)
- [Android 앱 다운로드](https://go.toongether.kr/android)
